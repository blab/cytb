...
def generate_family_ordering(family_order_df):
    ...
    # Randomize order sorting for better color distribution
    random.seed(99)  # Set seed for reproducibility
    randomized_orders = list(grouped.keys())
    random.shuffle(randomized_orders)
